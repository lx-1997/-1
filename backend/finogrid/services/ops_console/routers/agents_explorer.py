...
async def list_agents(
    ...
    try:
        ...
        log.warning("list_agents_error", error=str(exc))
...
async def get_agent_detail(
    ...
    return {
        ...
        "kya": {
            ...
            "validator_expires_at": kya.validator_expires_at if (kya and kya.validator_expires_at) else None,
        } if kya else None,
        "wallets": [
            {
                "wallet_id": str(w.id),
        ...
        "recent_transactions": [
            {
                ...
                "settled_at": t.settled_at if t.settled_at else None,
            }
            for t in txs
        ],
    }
